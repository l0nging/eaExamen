...
* ## _Ejemplo de Hash Table_
  ...
  También podemos hacerla más simple:
...
~~~
  En este código, se utiliza la hash table para almacenar y buscar objetos "Data" con una clave de cadena de caracteres, y muestra los valores correspondientes para cada objeto encontrado. 
